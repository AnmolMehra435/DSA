===============================
LINKED LIST PATTERN-WISE (STRIVER)
===============================

1. LINKED LIST BASICS (Singly LL)
---------------------------------
- Intro to Singly LL                    -> GFG
- Insertion at the head of LL           -> GFG
- Deletion of the head of LL            -> GFG
- Find the length of the LL             -> GFG
- Search in LL                          -> GFG

2. DOUBLY LINKED LIST BASICS
----------------------------
- Intro to Doubly LL                    -> GFG
- Insert node before head in DLL        -> GFG
- Delete head of DLL                   -> GFG
- Reverse a DLL                         -> GFG

3. FAST & SLOW POINTER PATTERN
-------------------------------
- Middle of LL                          -> LeetCode 876
- Detect a loop in LL                  -> LeetCode 141
...
- Reverse LL in group of given size k   -> LeetCode 25
...
====================================
MAJOR PATTERNS TO STUDY FOR LL
====================================

1. Fast & Slow Pointer
2. Linked List Reversal
3. Two Pointer
4. Node Rearrangement
5. Merge Sort on LL
6. Arithmetic on LL
7. Multi-level LL
8. Hashing / Deep Copy